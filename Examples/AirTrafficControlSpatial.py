...
from optimization.SpatialSeparation import spatialSeparation
...
def nonlcon(x, params):
    ...
    separation = spatialSeparation(trajs) - params.dsafe**2
...
class Parameters:
    def __init__(self):
        ...
        self.dsafe = 10         # Minimum safe distance between trajectories (m)
